...
const conv1Messages: InboxMessage[] = [
  ...
  createMessage('msg-1-8', 'conv-1', 'contact-1', 'outbound', 'Perfeito! Vou montar uma proposta especial para e-commerce de moda. Te envio ainda hoje!', hoursAgo(0.5), 'delivered'),
  createMessage('msg-1-9', 'conv-1', 'contact-1', 'inbound', 'Ótimo! Aguardo o orçamento, por favor!', minutesAgo(5)),
];

// Conversa 2 - Dúvida de preço
const conv2Messages: InboxMessage[] = [
  ...
  createMessage('msg-2-3', 'conv-2', 'contact-2', 'inbound', 'Vi o anúncio de vocês e fiquei interessado', hoursAgo(3.8)),
  ...
  createMessage('msg-2-6', 'conv-2', 'contact-2', 'outbound', 'Sim! Temos planos mensais, trimestrais e anuais. O mensal tem mais flexibilidade, já o anual tem um desconto especial de 20%.', hoursAgo(1.8), 'read'),
...
const conv4Messages: InboxMessage[] = [
  ...
  createMessage('msg-4-4', 'conv-4', 'contact-4', 'outbound', 'Entendi. Você já tentou limpar o cache do navegador?', hoursAgo(4.5), 'read'),
  createMessage('msg-4-5', 'conv-4', 'contact-4', 'inbound', 'Sim, já tentei e não funcionou', hoursAgo(4)),
  createMessage('msg-4-6', 'conv-4', 'contact-4', 'outbound', 'Ok, vou verificar no sistema. Um momento, por favor...', hoursAgo(3.8), 'read'),
  createMessage('msg-4-7', 'conv-4', 'contact-4', 'outbound', 'Encontrei o problema! Era uma configuração de permissão. Já corrigi aqui. Pode tentar acessar novamente?', hoursAgo(3.2), 'read'),
  createMessage('msg-4-8', 'conv-4', 'contact-4', 'inbound', 'Agora funcionou! Muito obrigado!', hoursAgo(3)),
  createMessage('msg-4-9', 'conv-4', 'contact-4', 'outbound', 'Pronto, problema resolvido! Qualquer dúvida estou à disposição.', hoursAgo(2), 'read'),
];
...
const conv5Messages: InboxMessage[] = [
  ...
  createMessage('msg-5-4', 'conv-5', 'contact-5', 'inbound', 'As vendas aumentaram 30% esse mês', hoursAgo(6.5)),
  createMessage('msg-5-5', 'conv-5', 'contact-5', 'outbound', 'Uau! Esse é um resultado incrível! Parabéns! 🚀', hoursAgo(6.3), 'read'),
...
const conv6Messages: InboxMessage[] = [
  ...
  createMessage('msg-6-4', 'conv-6', 'contact-6', 'outbound', 'Segue o link do nosso catálogo digital: www.exemplo.com/catalogo', hoursAgo(9.3), 'read'),
  ...
  createMessage('msg-6-7', 'conv-6', 'contact-6', 'inbound', 'O produto da página 5 está disponível?', hoursAgo(7)),
  createMessage('msg-6-8', 'conv-6', 'contact-6', 'outbound', 'Sim! Temos em estoque. Deseja fazer o pedido?', hoursAgo(6.5), 'read'),
  createMessage('msg-6-9', 'conv-6', 'contact-6', 'outbound', 'Segue o link do nosso catálogo atualizado!', hoursAgo(6), 'read'),
];

// Conversa 7 - Pagamento
const conv7Messages: InboxMessage[] = [
  ...
  createMessage('msg-7-3', 'conv-7', 'contact-7', 'inbound', 'Claro, segue em anexo', hoursAgo(14.5)),
...
// Conversa 8 - Horário de funcionamento
const conv8Messages: InboxMessage[] = [
  createMessage('msg-8-1', 'conv-8', 'contact-8', 'inbound', 'Boa noite! Qual o horário de funcionamento?', hoursAgo(22)),
  ...
  createMessage('msg-8-6', 'conv-8', 'contact-8', 'outbound', 'Sim! Fazemos atendimento presencial e por videochamada, como preferir.', hoursAgo(18.5), 'read'),
  createMessage('msg-8-7', 'conv-8', 'contact-8', 'inbound', 'Ótimo! Vou agendar para a semana que vem então.', hoursAgo(18.2)),
  createMessage('msg-8-8', 'conv-8', 'contact-8', 'outbound', 'Nosso horário de funcionamento é de seg a sex, das 9h às 18h.', hoursAgo(18), 'read'),
];
...
const conv10Messages: InboxMessage[] = [
  ...
  createMessage('msg-10-5', 'conv-10', 'contact-10', 'inbound', 'São 15 vendedores, faturamento de 500k/mês', daysAgo(3)),
  createMessage('msg-10-6', 'conv-10', 'contact-10', 'outbound', 'Excelente! Vou preparar uma proposta personalizada para vocês.', daysAgo(2.8), 'read'),
  createMessage('msg-10-7', 'conv-10', 'contact-10', 'inbound', 'Obrigado! Aguardo', daysAgo(2.5)),
  createMessage('msg-10-8', 'conv-10', 'contact-10', 'outbound', 'Vou analisar e retorno.', daysAgo(2), 'sent'),
];
...
const conv11Messages: InboxMessage[] = [
  ...
  createMessage('msg-11-8', 'conv-11', 'contact-11', 'outbound', 'Para esse CEP, o frete fica em R$ 35,00. Deseja prosseguir?', daysAgo(4), 'read'),
...
const conv12Messages: InboxMessage[] = [
  ...
  createMessage('msg-12-3', 'conv-12', 'contact-12', 'inbound', 'Claro, segue a foto', daysAgo(7.5)),
  ...
  createMessage('msg-12-7', 'conv-12', 'contact-12', 'inbound', 'Que atendimento excelente! Muito obrigado!', daysAgo(6.5)),
